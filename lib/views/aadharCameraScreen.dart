...
class AadharCameraScreen extends StatefulWidget {
  AadharCameraScreenState createState() => AadharCameraScreenState();
}

class AadharCameraScreenState extends State<AadharCameraScreen> {
